  ...
  return (
    <section style={{ background: "#000", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
      <style>{`
        ...
        .pc-btn:hover { background: rgba(255,255,255,0.1) !important; }
          ...
          <div className="flex items-center justify-between mt-5">
            ...
            <div className="flex gap-2">
              <button onClick={prev} className="pc-btn w-8 h-8 rounded-full flex items-center justify-center"
                style={{ background: "rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.12)", transition: "background 0.15s" }}>
                <ChevronLeft size={16} />
              </button>
              ...
              {partners.map((_, i) => (
                <button key={i} onClick={() => go(i)} className="pc-dot-btn rounded-full"
                  style={{
                    ...
                    height: "6px",
                    background: i === current ? "#9147ff" : "rgba(255,255,255,0.2)",
